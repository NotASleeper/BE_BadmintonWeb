...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert("grndetails", [
      ...
      { grnid: 10, productid: 16, price: 750000, quantity: 1,
        createdAt: new Date("2025-06-11"),
        updatedAt: new Date("2025-06-11"), }, // bán: 839,000
      { grnid: 10, productid: 28, price: 59000, quantity: 3 ,
        createdAt: new Date("2025-06-11"),
        updatedAt: new Date("2025-06-11"),}, // bán: 60,000
      { grnid: 10, productid: 21, price: 59000, quantity: 2,
        createdAt: new Date("2025-06-11"),
        updatedAt: new Date("2025-06-11"), }, // bán: 160,000
    ]);
  },
