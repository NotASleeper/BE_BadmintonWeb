    ...
    await queryInterface.bulkInsert("orders", [
      {
        ...
        promotionid: null,
        status: 1,
        process: new Date("2025-05-02"),
        shipping: new Date("2025-05-04"),
        delivered: new Date("2025-05-07"),
      ...
      },
      {
        ...
        promotionid: null,
        status: 1,
        process: new Date("2025-05-10"),
        shipping: new Date("2025-05-12"),
        delivered: new Date("2025-05-14"),
      ...
      },
      {
        ...
        promotionid: null,
        status: 1,
        process: new Date("2025-05-20"),
        shipping: new Date("2025-05-22"),
        delivered: new Date("2025-05-25"),
      ...
      },
      {
        ...
        promotionid: null,
        status: 1,
        process: new Date("2025-06-01"),
        shipping: new Date("2025-06-02"),
        delivered: new Date("2025-06-05"),
      ...
      },
      {
        ...
        promotionid: null,
        status: 1,
        process: new Date("2025-05-07"),
        shipping: new Date("2025-05-10"),
        delivered: new Date("2025-05-12"),
      ...
      },
      {
        ...
        status: 1,
        process: new Date("2025-06-01"),
        shipping: new Date("2025-06-03"),
        delivered: new Date("2025-06-06"),
        createdAt: new Date("2025-06-01"),
        updatedAt: new Date("2025-06-01"),
      },
      {
        ...
        promotionid: null,
        status: 1,
        process: new Date("2025-05-18"),
        shipping: new Date("2025-05-19"),
        delivered: new Date("2025-05-22"),
      ...
      },
      {
        ...
        promotionid: null,
        status: 1,
        process: new Date("2025-05-25"),
        shipping: new Date("2025-05-27"),
        delivered: new Date("2025-05-29"),
      ...
      },
      {
        ...
        promotionid: null,
        status: 1,
        process: new Date("2025-05-29"),
        shipping: new Date("2025-06-01"),
        delivered: new Date("2025-06-03"),
